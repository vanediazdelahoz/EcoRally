    ...
    def __init__(self, game):
        ...
        try:
            self.fondo = pygame.image.load(
                "assets/CosasDeMinijuegos/FondoLluvia.png"
            ).convert()
        ...
        try:
            for basura in self.tipos_basura:
                imagen = pygame.image.load(
                    f"assets/CosasDeMinijuegos/Basura/{basura['img']}"
                ).convert_alpha()
        ...
        try:
            self.caneca_img = pygame.image.load(
                "assets/CosasDeMinijuegos/Canasta de basura/CanecaX.png"
            ).convert_alpha()
        ...
        if self.game_state == "PLAYING":
            ...
            if not self.player2_is_bot:
                ...
                if (
                    ...
                    # Buscar la basura más cercana al fondo (mayor Y)
                    ...
                    # Si está a la izquierda, muévete a la derecha (y viceversa)
                    if (
